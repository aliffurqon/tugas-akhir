                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Ubah Instruktur :</strong>
                                <select name="status_pembayaran" class="form-control">
                                @if ( !empty($jadwal->karyawan_id) ){
                                    <option value="{{ $jadwal->karyawan_id }}" selected>--- {{ $jadwal->karyawan_id }} ---</option>
                                }@else{  
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            <button type="submit" class="btn btn-primary">Ubah Jadwal Instruktur</button>
                        </div>
                    </div>
                </form>
            </div>
